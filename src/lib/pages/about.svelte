		...
		<div class="max-w-md">
			...
			<div class="mt-12">
				...
				<a href="https://mcserversoft.com/donate" target="_blank" rel="noopener noreferrer">
					<img src="kofi_banner.png" alt="Support me on Ko-fi" class="scale-50" />
				</a>

				<div class="flex space-x-3 justify-center">
					<a href="https://twitter.com/fiahblade" target="_blank" rel="noopener noreferrer">
					...
					<a href="https://mcserversoft.com/discord" target="_blank" rel="noopener noreferrer">
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 71 55" class="fill-current">
							<path
					...
					<a href="https://github.com/mcserversoft/RemotePanel" target="_blank" rel="noopener noreferrer">
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="fill-current">
							<path
