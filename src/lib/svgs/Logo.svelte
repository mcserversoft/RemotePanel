...
<svg {width} {height} class={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2134 2134" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2">
	...
	<g transform="matrix(4.3501 0 0 4.3501 -19.0235 -48.5561)">
		<clipPath id="A">
			<path d="M248.557 499C227.84 499 45.461 390.228 38.113 377.5c-9.221-15.971-7.618-229.806 0-243C48.362 116.748 227.84 13.001 248.557 13.001c23.778 0 198.65 101.074 210.443 121.5 12.659 21.927 9.549 226.46 0 242.999C449.509 393.938 267.961 499 248.557 499z" />
		</clipPath>
