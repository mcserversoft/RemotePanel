...
<input
	...
	class="block w-full p-2.5 text-sm rounded-lg {error
		...
		: 'bg-gray-50 text-gray-900  border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white focus:border-blue-500 focus:ring-blue-500 dark:focus:border-blue-500 dark:focus:ring-blue-500 '} {inputClass}"
	{placeholder}
	{required}
	{min}
	{max}
