...
<div class="flex items-center" use:clickOutside on:click_outside={handleClickOutside}>
	<div class="relative inline-block text-left">
		...
		{#if isOpen}
			<div class="absolute right-0 rounded-lg divide-y w-48 bg-white divide-gray-100 dark:bg-gray-600 dark:divide-gray-500">
				...
				<ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownUserAvatarButton">
					<li>
						<button on:click={() => navigateClick(Page.Account)} class="px-4 0 py-2 w-full text-left hover:bg-gray-100 dark:hover:bg-gray-500 dark:hover:text-white">Account & Profile</button>
					</li>
					<li>
						<button on:click={() => navigateClick(Page.Settings)} class="px-4 py-2 w-full text-left hover:bg-gray-100 dark:hover:bg-gray-500 dark:hover:text-white">Settings</button>
					</li>
					<li>
						<button on:click={() => navigateClick(Page.About)} class="px-4 py-2 w-full text-left hover:bg-gray-100 dark:hover:bg-gray-500 dark:hover:text-white">About</button>
					</li>
				</ul>
				<div class="py-2">
